...
//		BufferedImage image = UtilImageIO.loadImage("images/portrait_2048.jpg");
		...
		GrayU8 grayU8 = ConvertBufferedImage.convertFrom(image, (GrayU8)null);
		
		GrayU16 grayU16 = ConvertImage.convert(grayU8, (GrayU16)null);

		calculateVarianceBoofCV(grayU16);
		
		calculateVarianceHistogram(grayU16);
	}
	
	private static void calculateVarianceBoofCV(GrayU16 result) {
	...
	private static void calculateVarianceHistogram(GrayU16 result) {
		...
		double mean = mean(result, histogram);
	 ...
	 * 
	 * @param histogram Histogram of a GrayU16 image.
	 ...
	 * @return Mean pixel intensity value
	 */
	public static double mean(GrayU16 input, int[] histogram) {
		if(histogram==null) {
	 ...
	 */
	public static double variance(GrayU16 input, int[] histogram) {
		if(histogram==null) {
			histogram = new int[65536];
		}
		ImageStatistics.histogram(input, histogram);
